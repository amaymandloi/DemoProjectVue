        ...
        <div class="right-content">
          <v-form id="form" @submit.prevent="formValidation">
            <div class="form-control">
              ...
              <v-text-field type="text" id="username" placeholder="Username" v-model="username" />
              <span v-if="errorUsername" class="error">{{
                errorUsername
              }}</span>
            </div>
            <div class="form-control">
              <v-text-field v-model="email" placeholder="Email" type="text" id="email" />
              <span v-if="errorEmail" class="error">{{ errorEmail }}</span>
            </div>
            <div class="form-control">
              <v-text-field v-model="password" type="password" placeholder="Password" id="password" />
